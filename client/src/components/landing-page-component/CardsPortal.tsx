...
const Card: React.FC<CardProps> = ({ to, title, description, icon }) => (
  <Link
    to={to}
    className="flex flex-col items-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 bg-blie"
  >
